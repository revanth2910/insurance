...
public class TC_RQ_005 extends BaseClass {
	...
	public void quote() throws InterruptedException
	{
		...
		//rq.SelectQue("Business","construction","retail");
		logger.info("clicked on business insurance and selected construction, retail");
