...
public class TC_RQ_004 extends BaseClass {
	...
	public void quote() throws InterruptedException
	{
		...
		//rq.SelectQue("Personal","condo","home");
		logger.info("clicked on personal insurance and selected condo, home ");
